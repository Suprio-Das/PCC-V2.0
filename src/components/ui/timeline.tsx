...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="w-full bg-white dark:bg-neutral-950 font-sans md:px-10" ref={containerRef}>
      <div className="mx-auto pt-20 px-4 md:px-8 lg:px-10 text-center">
        <h2 className="text-lg md:text-5xl font-semibold mb-4 text-black dark:text-white">
          ...
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <div className="flex flex-col mb-2 md:mb-0">
                <h3 className="md:hidden text-2xl text-left font-bold text-neutral-500 dark:text-neutral-500">
                  {item.title}
                </h3>
                <h3 className="md:hidden text-md md:pl-20 md:text-xl font-bold text-neutral-500 dark:text-neutral-500 ">
                  {item.date}
                </h3>
              </div>
              {item.content}{' '}
