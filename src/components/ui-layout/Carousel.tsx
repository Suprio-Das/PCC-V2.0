...
import React, { ReactNode, createContext, useCallback, useContext, useEffect, useId, useRef, useState } from 'react';
...
export const SliderPrevButton = ({ children, className }: { children?: ReactNode; className?: string }) => {
...
export const SliderNextButton = ({ children, className }: { children?: ReactNode; className?: string }) => {
