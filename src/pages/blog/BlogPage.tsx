...
const tags = ['Blogging', 'Web Development', 'Digital Marketing', 'Cooking', 'Photography', 'Sports'];
    ...
    <>
      ...
      <div className="bg-green-50 dark:bg-gray-900">
        ...
        <section className="relative flex flex-col items-center justify-center text-center py-24 px-6 overflow-hidden">
          ...
          >
            <h1 className="text-5xl md:text-6xl  drop-shadow-md bg-gradient-to-r from-primary to-black dark:to-white text-transparent bg-clip-text pb-4">
              Our Blogs
            </h1>
        ...
        {/* Blog Section */}
        <section className="w-11/12 mx-auto pt-16 pb-24">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6 space-y-8 transition-colors duration-300">
              ...
              <div>
                <h2 className="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-100">Subscribe to Newsletter</h2>
