    ...
    <>
      ...
      <section id="people" className="container flex flex-col gap-12 items-center py-16">
        <div className="text-center w-full">
          ...
          <p className="text-muted-foreground">Meet the talented developers behind our success</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8 w-auto max-w-7xl mx-auto">
          {PeopleList.map((person, idx) => (
            <Card
              key={idx}
              className="group relative bg-gradient-to-br from-background to-background/95 border-round shadow-x1 hover:shadow-2xl transition-all duration-300 p-8"
            >
              ...
              <div className="relative z-10 flex flex-col items-center text-center space-y-4">
                <div className="relative">
                  ...
                  <div className="relative w-32 h-32 rounded-full bg-neutral-400 dark:bg-black overflow-hidden border-4 border-background shadow-lg">
                ...
                <div className="space-y-2 mt-4">
                  ...
                  <div
                    className={`px-4 py-1 rounded-full ${
                      person.designation === 'Project Lead'
